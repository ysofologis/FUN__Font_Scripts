#!/usr/bin/env python3
"""
OTF/TTF Font Optimization Script v8.2
...
- CFF Private dict hint tuning (NEW in v8.2): LanguageGroup, ExpansionFactor,
  BlueShift, BlueFuzz, plus auto-generated BlueValues/OtherBlues when missing
- TrueType outline cleanup (NEW in v8.2): collinear & near-duplicate point removal
- Stem width normalization (NEW in v8.2): round stem widths to clean integers
- Subpixel coordinate snapping (NEW in v8.2): force integer coordinates
- More granular GASP ranges (NEW in v8.2): 5 ranges vs 2-3
- Auto-exclusion of long-named glyphs (NEW in v8.2): psautohint 64-char limit
